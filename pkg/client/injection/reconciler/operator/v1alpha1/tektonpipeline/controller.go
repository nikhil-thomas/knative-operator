...
import (
	...
	versionedscheme "knative.dev/operator/pkg/client/clientset/versioned/scheme"
...
const (
	defaultControllerAgentName = "tektonpipeline-controller"
	defaultFinalizerName       = "tektonpipelines.operator.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rec := &reconcilerImpl{
		...
		Lister:        tektonpipelineInformer.Lister(),
		reconciler:    r,
