...
// controller reconciling v1alpha1.TektonPipeline.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1alpha1.TektonPipeline. Any changes
	// to the objects .Status or .Finalizers will be propagated to the stored
	// object. It is recommended that implementors do not call any update calls
	// for the Kind inside of ReconcileKind, it is the responsibility of the calling
	// controller to propagate those properties. The resource passed to ReconcileKind
	// will always have an empty deletion timestamp.
	ReconcileKind(ctx context.Context, o *v1alpha1.TektonPipeline) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1alpha1.TektonPipeline.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1alpha1.TektonPipeline. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1alpha1.TektonPipeline) reconciler.Event
}

// reconcilerImpl implements controller.Reconciler for v1alpha1.TektonPipeline resources.
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister operatorv1alpha1.TektonPipelineLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.TektonPipelines(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.TektonPipeline, desired *v1alpha1.TektonPipeline) error {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1alpha1.TektonPipeline, reconcileEvent reconciler.Event) (*v1alpha1.TektonPipeline, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
