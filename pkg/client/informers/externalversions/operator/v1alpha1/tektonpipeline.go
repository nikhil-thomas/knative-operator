...
func (f *tektonPipelineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&operatorv1alpha1.TektonPipeline{}, f.defaultInformer)
}

func (f *tektonPipelineInformer) Lister() v1alpha1.TektonPipelineLister {
	return v1alpha1.NewTektonPipelineLister(f.Informer().GetIndexer())
}
