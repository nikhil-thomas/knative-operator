...
var tektonpipelinesResource = schema.GroupVersionResource{Group: "operator.knative.dev", Version: "v1alpha1", Resource: "tektonpipelines"}

var tektonpipelinesKind = schema.GroupVersionKind{Group: "operator.knative.dev", Version: "v1alpha1", Kind: "TektonPipeline"}
